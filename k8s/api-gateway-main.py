...
UPSTREAM_TIMEOUT_SECONDS = float(os.getenv("UPSTREAM_TIMEOUT_SECONDS", "210"))
        ...
        try:
            ...
            return JSONResponse(
                ...
                content={
                    ...
                    "fallback": "A resposta demorou mais que o limite configurado. Tente novamente em alguns segundos.",
                },
            )
